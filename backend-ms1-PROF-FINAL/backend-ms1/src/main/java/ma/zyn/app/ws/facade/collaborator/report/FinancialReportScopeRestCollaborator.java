...
@RestController
@RequestMapping("/api/collaborator/financialReportScope/")
public class FinancialReportScopeRestCollaborator {
   ...
   public FinancialReportScopeRestCollaborator(FinancialReportScopeCollaboratorService service, FinancialReportScopeConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final FinancialReportScopeCollaboratorService service;
