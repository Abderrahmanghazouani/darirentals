...
@RestController
@RequestMapping("/api/admin/serviceProvider/")
public class ServiceProviderRestAdmin {
   ...
   public ServiceProviderRestAdmin(ServiceProviderAdminService service, ServiceProviderConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final ServiceProviderAdminService service;
