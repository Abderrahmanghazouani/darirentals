package  ma.zyn.app.ws.facade.collaborator.client;
...
@RestController
@RequestMapping("/api/collaborator/client/")
public class ClientRestCollaborator {
    ...
    public List<ClientDto> findByEnterpriseId(@PathVariable Long id){
   ...
   public ClientRestCollaborator(ClientCollaboratorService service, ClientConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final ClientCollaboratorService service;
