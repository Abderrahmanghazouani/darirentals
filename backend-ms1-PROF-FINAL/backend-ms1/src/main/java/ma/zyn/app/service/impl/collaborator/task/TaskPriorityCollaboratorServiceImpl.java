...
import java.util.List;
@Service
public class TaskPriorityCollaboratorServiceImpl implements TaskPriorityCollaboratorService {
    ...
    public TaskPriorityCollaboratorServiceImpl(TaskPriorityDao dao) {
        this.dao = dao;
    }
