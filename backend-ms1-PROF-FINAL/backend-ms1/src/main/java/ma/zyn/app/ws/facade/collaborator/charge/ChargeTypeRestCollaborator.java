...
@RestController
@RequestMapping("/api/collaborator/chargeType/")
public class ChargeTypeRestCollaborator {
   ...
   public ChargeTypeRestCollaborator(ChargeTypeCollaboratorService service, ChargeTypeConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final ChargeTypeCollaboratorService service;
