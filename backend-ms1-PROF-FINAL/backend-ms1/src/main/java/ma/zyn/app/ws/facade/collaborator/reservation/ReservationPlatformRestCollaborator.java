...
@RestController
@RequestMapping("/api/collaborator/reservationPlatform/")
public class ReservationPlatformRestCollaborator {
   ...
   public ReservationPlatformRestCollaborator(ReservationPlatformCollaboratorService service, ReservationPlatformConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final ReservationPlatformCollaboratorService service;
