...
import java.util.List;
@Service
public class EnterpriseMembershipAdminServiceImpl implements EnterpriseMembershipAdminService {
    ...
    @Autowired
    private CollaboratorPermissionOverrideAdminService collaboratorPermissionOverrideService ;
    @Autowired
    private EnterpriseAdminService enterpriseService ;
    @Autowired
    private CollaboratorRoleAdminService collaboratorRoleService ;

    public EnterpriseMembershipAdminServiceImpl(EnterpriseMembershipDao dao) {
        this.dao = dao;
    }
