...
import java.util.List;
@Service
public class ReservationStatusClientServiceImpl implements ReservationStatusClientService {
    ...
    public ReservationStatusClientServiceImpl(ReservationStatusDao dao) {
        this.dao = dao;
    }
