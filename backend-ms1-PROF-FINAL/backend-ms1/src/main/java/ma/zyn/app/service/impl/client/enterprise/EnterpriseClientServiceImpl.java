package ma.zyn.app.service.impl.client.enterprise;
...
import ma.zyn.app.service.facade.client.ai.AiQuotaClientService ;
import ma.zyn.app.bean.core.ai.AiQuota ;
import ma.zyn.app.service.facade.client.ai.AiUsageLogClientService ;
...
import ma.zyn.app.service.facade.client.currency.CurrencyClientService ;
...
public class EnterpriseClientServiceImpl implements EnterpriseClientService {
    ...
    @Autowired
    private AiQuotaClientService aiQuotaService ;
    @Autowired
    private AiUsageLogClientService aiUsageLogService ;
    @Autowired
    private ServiceProviderClientService serviceProviderService ;
    @Autowired
    private CurrencyClientService currencyService ;
    @Autowired
    private FinancialReportClientService financialReportService ;
    @Autowired
    ...
    public EnterpriseClientServiceImpl(EnterpriseDao dao) {
        this.dao = dao;
    }
