...
@RestController
@RequestMapping("/api/admin/reservationStatus/")
public class ReservationStatusRestAdmin {
   ...
   public ReservationStatusRestAdmin(ReservationStatusAdminService service, ReservationStatusConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final ReservationStatusAdminService service;
