...
@RestController
@RequestMapping("/api/collaborator/currency/")
public class CurrencyRestCollaborator {
   ...
   public CurrencyRestCollaborator(CurrencyCollaboratorService service, CurrencyConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final CurrencyCollaboratorService service;
