...
import java.util.List;
@Service
public class AiUsageLogClientServiceImpl implements AiUsageLogClientService {
    ...
    @Autowired
    private AiUsageTypeClientService aiUsageTypeService ;
    @Autowired
    private EnterpriseClientService enterpriseService ;
    @Autowired
    private DocumentClientService documentService ;

    public AiUsageLogClientServiceImpl(AiUsageLogDao dao) {
        this.dao = dao;
    }
