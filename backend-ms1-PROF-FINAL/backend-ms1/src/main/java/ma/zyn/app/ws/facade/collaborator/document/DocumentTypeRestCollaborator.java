package  ma.zyn.app.ws.facade.collaborator.document;
...
@RestController
@RequestMapping("/api/collaborator/documentType/")
public class DocumentTypeRestCollaborator {
    ...
    @Operation(summary = "Finds a documentType by label")
    @GetMapping("label/{label}")
    public ResponseEntity<DocumentTypeDto> findByLabel(@PathVariable String label) {
	    DocumentType t = service.findByReferenceEntity(new DocumentType(label));
        if (t != null) {
            DocumentTypeDto dto = converter.toDto(t);
            return getDtoResponseEntity(dto);
        }
   ...
   public DocumentTypeRestCollaborator(DocumentTypeCollaboratorService service, DocumentTypeConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final DocumentTypeCollaboratorService service;
    private final DocumentTypeConverter converter;
