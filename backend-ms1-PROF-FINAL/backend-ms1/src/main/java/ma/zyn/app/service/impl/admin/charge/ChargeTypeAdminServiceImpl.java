package ma.zyn.app.service.impl.admin.charge;
...
import java.util.List;
@Service
public class ChargeTypeAdminServiceImpl implements ChargeTypeAdminService {
    ...
    public ChargeTypeAdminServiceImpl(ChargeTypeDao dao) {
        this.dao = dao;
    }
