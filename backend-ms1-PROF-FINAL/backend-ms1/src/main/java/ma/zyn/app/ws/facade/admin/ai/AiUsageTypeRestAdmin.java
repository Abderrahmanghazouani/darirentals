...
@RestController
@RequestMapping("/api/admin/aiUsageType/")
public class AiUsageTypeRestAdmin {
   ...
   public AiUsageTypeRestAdmin(AiUsageTypeAdminService service, AiUsageTypeConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final AiUsageTypeAdminService service;
