...
@Service
public class CollaboratorPropertyAccessCollaboratorServiceImpl implements CollaboratorPropertyAccessCollaboratorService {
    ...
    public CollaboratorPropertyAccessCollaboratorServiceImpl(CollaboratorPropertyAccessDao dao) {
        this.dao = dao;
    }
