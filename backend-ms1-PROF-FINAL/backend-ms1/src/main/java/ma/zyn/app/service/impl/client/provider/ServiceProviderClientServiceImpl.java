package ma.zyn.app.service.impl.client.provider;
...
import ma.zyn.app.service.facade.client.provider.ServiceTypeClientService ;
...
import java.util.List;
@Service
public class ServiceProviderClientServiceImpl implements ServiceProviderClientService {
    ...
    @Autowired
    private ServiceTypeClientService serviceTypeService ;
    @Autowired
    private EnterpriseClientService enterpriseService ;

    public ServiceProviderClientServiceImpl(ServiceProviderDao dao) {
        this.dao = dao;
    }
