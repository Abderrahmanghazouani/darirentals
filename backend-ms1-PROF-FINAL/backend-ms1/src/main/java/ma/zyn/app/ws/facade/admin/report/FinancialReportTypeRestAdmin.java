...
@RestController
@RequestMapping("/api/admin/financialReportType/")
public class FinancialReportTypeRestAdmin {
   ...
   public FinancialReportTypeRestAdmin(FinancialReportTypeAdminService service, FinancialReportTypeConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final FinancialReportTypeAdminService service;
