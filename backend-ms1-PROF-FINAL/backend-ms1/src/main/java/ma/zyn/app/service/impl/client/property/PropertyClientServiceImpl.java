...
import ma.zyn.app.service.facade.client.property.PropertyTypeClientService ;
...
import java.util.List;
@Service
public class PropertyClientServiceImpl implements PropertyClientService {
    ...
    @Autowired
    private TaskClientService taskService ;
    @Autowired
    ...
    @Autowired
    private PropertyTypeClientService propertyTypeService ;
    @Autowired
    private PropertyStatusClientService propertyStatusService ;
    @Autowired
    private CityClientService cityService ;
    @Autowired
    private ChargeClientService chargeService ;

    public PropertyClientServiceImpl(PropertyDao dao) {
        this.dao = dao;
    }
