...
import java.util.List;
@Service
public class FinancialReportPropertyCollaboratorServiceImpl implements FinancialReportPropertyCollaboratorService {
    ...
    public FinancialReportPropertyCollaboratorServiceImpl(FinancialReportPropertyDao dao) {
        this.dao = dao;
    }
