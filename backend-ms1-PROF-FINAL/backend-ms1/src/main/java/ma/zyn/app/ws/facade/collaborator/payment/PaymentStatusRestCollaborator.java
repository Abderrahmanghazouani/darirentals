package  ma.zyn.app.ws.facade.collaborator.payment;
...
@RestController
@RequestMapping("/api/collaborator/paymentStatus/")
public class PaymentStatusRestCollaborator {
   ...
   public PaymentStatusRestCollaborator(PaymentStatusCollaboratorService service, PaymentStatusConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final PaymentStatusCollaboratorService service;
