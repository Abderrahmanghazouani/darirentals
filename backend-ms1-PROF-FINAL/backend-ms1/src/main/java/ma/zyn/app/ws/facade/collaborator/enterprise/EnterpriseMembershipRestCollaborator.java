package  ma.zyn.app.ws.facade.collaborator.enterprise;
...
@RestController
@RequestMapping("/api/collaborator/enterpriseMembership/")
public class EnterpriseMembershipRestCollaborator {
   ...
   public EnterpriseMembershipRestCollaborator(EnterpriseMembershipCollaboratorService service, EnterpriseMembershipConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final EnterpriseMembershipCollaboratorService service;
