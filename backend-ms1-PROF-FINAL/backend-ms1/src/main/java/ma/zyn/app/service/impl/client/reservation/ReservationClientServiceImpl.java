...
import ma.zyn.app.service.facade.client.reservation.ReservationPlatformClientService ;
import ma.zyn.app.bean.core.reservation.ReservationPlatform ;
import ma.zyn.app.service.facade.client.reservation.ReservationStatusClientService ;
...
public class ReservationClientServiceImpl implements ReservationClientService {
    ...
    @Autowired
    private ReservationPlatformClientService reservationPlatformService ;
    @Autowired
    private ReservationStatusClientService reservationStatusService ;
    @Autowired
