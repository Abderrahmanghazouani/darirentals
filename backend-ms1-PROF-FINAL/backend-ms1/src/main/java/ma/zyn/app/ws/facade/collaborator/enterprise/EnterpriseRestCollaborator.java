...
@RestController
@RequestMapping("/api/collaborator/enterprise/")
public class EnterpriseRestCollaborator {
   ...
   public EnterpriseRestCollaborator(EnterpriseCollaboratorService service, EnterpriseConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final EnterpriseCollaboratorService service;
