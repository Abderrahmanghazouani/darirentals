...
@RestController
@RequestMapping("/api/collaborator/serviceType/")
public class ServiceTypeRestCollaborator {
   ...
   public ServiceTypeRestCollaborator(ServiceTypeCollaboratorService service, ServiceTypeConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final ServiceTypeCollaboratorService service;
