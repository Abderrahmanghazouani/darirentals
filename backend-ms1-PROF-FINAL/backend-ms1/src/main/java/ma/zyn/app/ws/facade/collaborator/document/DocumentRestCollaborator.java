...
@RestController
@RequestMapping("/api/collaborator/document/")
public class DocumentRestCollaborator {
   ...
   public DocumentRestCollaborator(DocumentCollaboratorService service, DocumentConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final DocumentCollaboratorService service;
