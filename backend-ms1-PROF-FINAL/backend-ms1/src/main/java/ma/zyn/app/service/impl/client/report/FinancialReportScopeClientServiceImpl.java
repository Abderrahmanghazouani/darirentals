...
import java.util.List;
@Service
public class FinancialReportScopeClientServiceImpl implements FinancialReportScopeClientService {
    ...
    public FinancialReportScopeClientServiceImpl(FinancialReportScopeDao dao) {
        this.dao = dao;
    }
