...
@RestController
@RequestMapping("/api/collaborator/reservation/")
public class ReservationRestCollaborator {
   ...
   public ReservationRestCollaborator(ReservationCollaboratorService service, ReservationConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final ReservationCollaboratorService service;
