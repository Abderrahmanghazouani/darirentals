...
@RestController
@RequestMapping("/api/collaborator/taskType/")
public class TaskTypeRestCollaborator {
   ...
   public TaskTypeRestCollaborator(TaskTypeCollaboratorService service, TaskTypeConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final TaskTypeCollaboratorService service;
