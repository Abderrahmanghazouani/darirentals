package ma.zyn.app.service.impl.client.task;
...
import ma.zyn.app.service.facade.client.task.TaskClientService;
...
import ma.zyn.app.service.facade.client.auth.CollaboratorClientService ;
import ma.zyn.app.bean.core.auth.Collaborator ;
import ma.zyn.app.service.facade.client.provider.ServiceProviderClientService ;
...
import ma.zyn.app.service.facade.client.task.TaskPriorityClientService ;
import ma.zyn.app.bean.core.task.TaskPriority ;
import ma.zyn.app.service.facade.client.task.TaskTypeClientService ;
import ma.zyn.app.bean.core.task.TaskType ;
import ma.zyn.app.service.facade.client.property.PropertyClientService ;
import ma.zyn.app.bean.core.property.Property ;
import ma.zyn.app.service.facade.client.task.TaskStatusClientService ;
...
public class TaskClientServiceImpl implements TaskClientService {
    ...
    @Autowired
    private CollaboratorClientService collaboratorService ;
    @Autowired
    private ServiceProviderClientService serviceProviderService ;
    @Autowired
    private ReservationClientService reservationService ;
    @Autowired
    private TaskPriorityClientService taskPriorityService ;
    @Autowired
    private TaskTypeClientService taskTypeService ;
    @Autowired
    private PropertyClientService propertyService ;
    @Autowired
    private TaskStatusClientService taskStatusService ;

    public TaskClientServiceImpl(TaskDao dao) {
        this.dao = dao;
    }
