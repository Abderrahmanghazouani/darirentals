...
import ma.zyn.app.service.facade.client.auth.CollaboratorRoleClientService ;
import ma.zyn.app.bean.core.auth.CollaboratorRole ;

import java.util.List;
@Service
public class EnterpriseMembershipClientServiceImpl implements EnterpriseMembershipClientService {
    ...
    @Autowired
    private CollaboratorPermissionOverrideClientService collaboratorPermissionOverrideService ;
    @Autowired
    private EnterpriseClientService enterpriseService ;
    @Autowired
    private CollaboratorRoleClientService collaboratorRoleService ;

    public EnterpriseMembershipClientServiceImpl(EnterpriseMembershipDao dao) {
        this.dao = dao;
    }
