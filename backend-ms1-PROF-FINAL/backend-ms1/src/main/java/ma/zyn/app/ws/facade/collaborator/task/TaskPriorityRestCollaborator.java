...
@RestController
@RequestMapping("/api/collaborator/taskPriority/")
public class TaskPriorityRestCollaborator {
   ...
   public TaskPriorityRestCollaborator(TaskPriorityCollaboratorService service, TaskPriorityConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final TaskPriorityCollaboratorService service;
