...
import java.util.List;
@Service
public class FinancialReportTypeCollaboratorServiceImpl implements FinancialReportTypeCollaboratorService {
    ...
    public FinancialReportTypeCollaboratorServiceImpl(FinancialReportTypeDao dao) {
        this.dao = dao;
    }
