...
import java.util.List;
@Service
public class ReservationPlatformCollaboratorServiceImpl implements ReservationPlatformCollaboratorService {
    ...
    public ReservationPlatformCollaboratorServiceImpl(ReservationPlatformDao dao) {
        this.dao = dao;
    }
