...
import java.util.List;
@Service
public class PropertyStatusCollaboratorServiceImpl implements PropertyStatusCollaboratorService {
    ...
    public PropertyStatusCollaboratorServiceImpl(PropertyStatusDao dao) {
        this.dao = dao;
    }
