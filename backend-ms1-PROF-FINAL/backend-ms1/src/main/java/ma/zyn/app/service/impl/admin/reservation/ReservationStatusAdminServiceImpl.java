...
import java.util.List;
@Service
public class ReservationStatusAdminServiceImpl implements ReservationStatusAdminService {
    ...
    public ReservationStatusAdminServiceImpl(ReservationStatusDao dao) {
        this.dao = dao;
    }
