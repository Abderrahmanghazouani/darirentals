...
@RestController
@RequestMapping("/api/admin/financialReport/")
public class FinancialReportRestAdmin {
   ...
   public FinancialReportRestAdmin(FinancialReportAdminService service, FinancialReportConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final FinancialReportAdminService service;
