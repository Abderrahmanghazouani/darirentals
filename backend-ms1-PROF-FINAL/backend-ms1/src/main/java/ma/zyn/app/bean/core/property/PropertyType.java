...
@SequenceGenerator(name="property_type_seq",sequenceName="property_type_seq",allocationSize=1, initialValue = 1)
public class PropertyType  extends BaseEntity     {
    ...
    public PropertyType(Long id,String label){
        this.id = id;
        this.label = label ;
    }
    ...
    public PropertyType(String label,String code){
        this.label=label;
        this.code=code;
    }
    ...
    public boolean equals(Object o) {
        ...
        return id != null && id.equals(propertyType.id);
    }
