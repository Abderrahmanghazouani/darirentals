...
@RestController
@RequestMapping("/api/admin/reservationRequestStatus/")
public class ReservationRequestStatusRestAdmin {
   ...
   public ReservationRequestStatusRestAdmin(ReservationRequestStatusAdminService service, ReservationRequestStatusConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final ReservationRequestStatusAdminService service;
