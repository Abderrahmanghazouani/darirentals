...
import ma.zyn.app.service.facade.collaborator.ai.AiUsageLogCollaboratorService ;
...
import java.util.List;
@Service
public class EnterpriseCollaboratorServiceImpl implements EnterpriseCollaboratorService {
    ...
    @Autowired
    private AiQuotaCollaboratorService aiQuotaService ;
    @Autowired
    private AiUsageLogCollaboratorService aiUsageLogService ;
    @Autowired
    private ServiceProviderCollaboratorService serviceProviderService ;
    @Autowired
    private CurrencyCollaboratorService currencyService ;
    @Autowired
    private FinancialReportCollaboratorService financialReportService ;
    @Autowired
    ...
    public EnterpriseCollaboratorServiceImpl(EnterpriseDao dao) {
        this.dao = dao;
    }
