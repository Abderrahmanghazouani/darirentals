...
import java.util.List;
@Service
public class AiUsageLogCollaboratorServiceImpl implements AiUsageLogCollaboratorService {
    ...
    @Autowired
    private AiUsageTypeCollaboratorService aiUsageTypeService ;
    @Autowired
    private EnterpriseCollaboratorService enterpriseService ;
    @Autowired
    private DocumentCollaboratorService documentService ;

    public AiUsageLogCollaboratorServiceImpl(AiUsageLogDao dao) {
        this.dao = dao;
    }
