...
@RestController
@RequestMapping("/api/collaborator/propertyType/")
public class PropertyTypeRestCollaborator {
   ...
   public PropertyTypeRestCollaborator(PropertyTypeCollaboratorService service, PropertyTypeConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final PropertyTypeCollaboratorService service;
