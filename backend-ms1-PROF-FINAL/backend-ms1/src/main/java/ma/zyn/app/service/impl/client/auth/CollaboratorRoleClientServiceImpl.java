...
import java.util.List;
@Service
public class CollaboratorRoleClientServiceImpl implements CollaboratorRoleClientService {
    ...
    public CollaboratorRoleClientServiceImpl(CollaboratorRoleDao dao) {
        this.dao = dao;
    }
