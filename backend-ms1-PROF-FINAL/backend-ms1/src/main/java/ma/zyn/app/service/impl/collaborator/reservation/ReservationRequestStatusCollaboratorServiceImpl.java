...
import java.util.List;
@Service
public class ReservationRequestStatusCollaboratorServiceImpl implements ReservationRequestStatusCollaboratorService {
    ...
    public ReservationRequestStatusCollaboratorServiceImpl(ReservationRequestStatusDao dao) {
        this.dao = dao;
    }
