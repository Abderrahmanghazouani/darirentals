...
import java.util.List;
@Service
public class CurrencyCollaboratorServiceImpl implements CurrencyCollaboratorService {
    ...
    @Autowired
    private ExchangeRateCollaboratorService exchangeRateService ;
    @Autowired
    private EnterpriseCollaboratorService enterpriseService ;

    public CurrencyCollaboratorServiceImpl(CurrencyDao dao) {
        this.dao = dao;
    }
