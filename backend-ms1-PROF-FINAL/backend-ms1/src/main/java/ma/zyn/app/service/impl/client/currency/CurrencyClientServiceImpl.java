package ma.zyn.app.service.impl.client.currency;
...
import ma.zyn.app.service.facade.client.currency.ExchangeRateClientService ;
...
public class CurrencyClientServiceImpl implements CurrencyClientService {
    ...
    @Autowired
    private ExchangeRateClientService exchangeRateService ;
    @Autowired
    private EnterpriseClientService enterpriseService ;

    public CurrencyClientServiceImpl(CurrencyDao dao) {
        this.dao = dao;
    }
