...
import java.util.List;
@Service
public class FinancialReportScopeCollaboratorServiceImpl implements FinancialReportScopeCollaboratorService {
    ...
    public FinancialReportScopeCollaboratorServiceImpl(FinancialReportScopeDao dao) {
        this.dao = dao;
    }
