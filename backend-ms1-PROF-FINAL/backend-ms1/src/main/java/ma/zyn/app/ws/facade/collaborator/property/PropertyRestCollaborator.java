...
@RestController
@RequestMapping("/api/collaborator/property/")
public class PropertyRestCollaborator {
   ...
   public PropertyRestCollaborator(PropertyCollaboratorService service, PropertyConverter converter){
