package  ma.zyn.app.ws.facade.collaborator.currency;
...
@RestController
@RequestMapping("/api/collaborator/exchangeRate/")
public class ExchangeRateRestCollaborator {
   ...
   public ExchangeRateRestCollaborator(ExchangeRateCollaboratorService service, ExchangeRateConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final ExchangeRateCollaboratorService service;
