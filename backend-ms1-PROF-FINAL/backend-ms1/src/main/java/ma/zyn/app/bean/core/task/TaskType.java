...
@SequenceGenerator(name="task_type_seq",sequenceName="task_type_seq",allocationSize=1, initialValue = 1)
public class TaskType  extends BaseEntity     {
    ...
    public TaskType(String label,String code){
        this.label=label;
        this.code=code;
    }
    ...
    public boolean equals(Object o) {
        ...
        return id != null && id.equals(taskType.id);
    }
