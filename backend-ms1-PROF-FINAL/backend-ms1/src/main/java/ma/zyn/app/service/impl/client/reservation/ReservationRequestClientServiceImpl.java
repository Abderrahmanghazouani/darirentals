package ma.zyn.app.service.impl.client.reservation;
...
import ma.zyn.app.service.facade.client.reservation.ReservationRequestStatusClientService ;
...
import java.util.List;
@Service
public class ReservationRequestClientServiceImpl implements ReservationRequestClientService {
    ...
    @Autowired
    private ReservationRequestStatusClientService reservationRequestStatusService ;
    @Autowired
    private ClientClientService clientService ;

    public ReservationRequestClientServiceImpl(ReservationRequestDao dao) {
        this.dao = dao;
    }
