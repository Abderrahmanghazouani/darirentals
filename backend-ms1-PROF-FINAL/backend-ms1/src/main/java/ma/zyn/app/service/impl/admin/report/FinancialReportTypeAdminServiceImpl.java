...
import java.util.List;
@Service
public class FinancialReportTypeAdminServiceImpl implements FinancialReportTypeAdminService {
    ...
    public FinancialReportTypeAdminServiceImpl(FinancialReportTypeDao dao) {
        this.dao = dao;
    }
