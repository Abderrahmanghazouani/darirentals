...
import java.util.List;
@Service
public class ReservationRequestStatusClientServiceImpl implements ReservationRequestStatusClientService {
    ...
    public ReservationRequestStatusClientServiceImpl(ReservationRequestStatusDao dao) {
        this.dao = dao;
    }
