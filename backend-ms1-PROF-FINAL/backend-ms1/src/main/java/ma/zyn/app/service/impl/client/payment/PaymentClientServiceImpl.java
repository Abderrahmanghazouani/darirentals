...
import ma.zyn.app.service.facade.client.payment.PaymentStatusClientService ;
...
public class PaymentClientServiceImpl implements PaymentClientService {
    ...
    @Autowired
    private PaymentStatusClientService paymentStatusService ;
    @Autowired
    private ServiceProviderClientService serviceProviderService ;
    @Autowired
    private PaymentTypeClientService paymentTypeService ;
    @Autowired
    private ChargeClientService chargeService ;

    public PaymentClientServiceImpl(PaymentDao dao) {
        this.dao = dao;
    }
