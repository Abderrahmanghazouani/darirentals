...
@RestController
@RequestMapping("/api/admin/propertyStatus/")
public class PropertyStatusRestAdmin {
   ...
   public PropertyStatusRestAdmin(PropertyStatusAdminService service, PropertyStatusConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final PropertyStatusAdminService service;
