...
@RestController
@RequestMapping("/api/admin/reservationRequest/")
public class ReservationRequestRestAdmin {
   ...
   public ReservationRequestRestAdmin(ReservationRequestAdminService service, ReservationRequestConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final ReservationRequestAdminService service;
