...
@RestController
@RequestMapping("/api/collaborator/reservationRequest/")
public class ReservationRequestRestCollaborator {
   ...
   public ReservationRequestRestCollaborator(ReservationRequestCollaboratorService service, ReservationRequestConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final ReservationRequestCollaboratorService service;
