...
import java.util.List;
@Service
public class DocumentTypeCollaboratorServiceImpl implements DocumentTypeCollaboratorService {
    ...
    public DocumentTypeCollaboratorServiceImpl(DocumentTypeDao dao) {
        this.dao = dao;
    }
