...
import ma.zyn.app.service.facade.client.report.FinancialReportClientService;
...
import ma.zyn.app.service.facade.client.report.FinancialReportPropertyClientService ;
...
import ma.zyn.app.service.facade.client.report.FinancialReportScopeClientService ;
import ma.zyn.app.bean.core.report.FinancialReportScope ;

import java.util.List;
@Service
public class FinancialReportClientServiceImpl implements FinancialReportClientService {
    ...
    @Autowired
    private FinancialReportTypeClientService financialReportTypeService ;
    @Autowired
    private FinancialReportPropertyClientService financialReportPropertyService ;
    @Autowired
    private EnterpriseClientService enterpriseService ;
    @Autowired
    private FinancialReportScopeClientService financialReportScopeService ;

    public FinancialReportClientServiceImpl(FinancialReportDao dao) {
        this.dao = dao;
    }
