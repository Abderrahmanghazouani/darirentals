...
@RestController
@RequestMapping("/api/admin/aiQuota/")
public class AiQuotaRestAdmin {
   ...
   public AiQuotaRestAdmin(AiQuotaAdminService service, AiQuotaConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final AiQuotaAdminService service;
