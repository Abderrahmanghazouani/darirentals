...
@RestController
@RequestMapping("/api/collaborator/aiUsageLog/")
public class AiUsageLogRestCollaborator {
   ...
   public AiUsageLogRestCollaborator(AiUsageLogCollaboratorService service, AiUsageLogConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final AiUsageLogCollaboratorService service;
