...
@RestController
@RequestMapping("/api/collaborator/financialReportProperty/")
public class FinancialReportPropertyRestCollaborator {
   ...
   public FinancialReportPropertyRestCollaborator(FinancialReportPropertyCollaboratorService service, FinancialReportPropertyConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final FinancialReportPropertyCollaboratorService service;
