...
@RestController
@RequestMapping("/api/collaborator/collaboratorRole/")
public class CollaboratorRoleRestCollaborator {
   ...
   public CollaboratorRoleRestCollaborator(CollaboratorRoleCollaboratorService service, CollaboratorRoleConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final CollaboratorRoleCollaboratorService service;
