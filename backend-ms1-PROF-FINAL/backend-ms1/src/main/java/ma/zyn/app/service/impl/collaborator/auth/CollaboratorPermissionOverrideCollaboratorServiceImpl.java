...
import java.util.List;
@Service
public class CollaboratorPermissionOverrideCollaboratorServiceImpl implements CollaboratorPermissionOverrideCollaboratorService {
    ...
    public void findOrSaveAssociatedObject(CollaboratorPermissionOverride t){
        if( t != null) {
            t.setEnterpriseMembership(enterpriseMembershipService.findOrSave(t.getEnterpriseMembership()));
        }
    }
    ...
    public CollaboratorPermissionOverrideCollaboratorServiceImpl(CollaboratorPermissionOverrideDao dao) {
        this.dao = dao;
    }
