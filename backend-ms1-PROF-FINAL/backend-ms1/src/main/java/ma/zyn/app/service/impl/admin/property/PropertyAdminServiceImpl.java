...
public class PropertyAdminServiceImpl implements PropertyAdminService {
    ...
    @Autowired
    private FinancialReportPropertyAdminService financialReportPropertyService ;
    @Autowired
    private ReservationRequestAdminService reservationRequestService ;
    @Autowired
    private EnterpriseAdminService enterpriseService ;
    @Autowired
    private PropertyTypeAdminService propertyTypeService ;
    @Autowired
    private PropertyStatusAdminService propertyStatusService ;
    @Autowired
