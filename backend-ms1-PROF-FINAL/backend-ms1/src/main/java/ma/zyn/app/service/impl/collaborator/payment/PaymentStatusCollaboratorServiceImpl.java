...
import java.util.List;
@Service
public class PaymentStatusCollaboratorServiceImpl implements PaymentStatusCollaboratorService {
    ...
    public PaymentStatusCollaboratorServiceImpl(PaymentStatusDao dao) {
        this.dao = dao;
    }
