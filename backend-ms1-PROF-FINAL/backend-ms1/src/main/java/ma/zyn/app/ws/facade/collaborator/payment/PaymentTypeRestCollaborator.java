...
@RestController
@RequestMapping("/api/collaborator/paymentType/")
public class PaymentTypeRestCollaborator {
   ...
   public PaymentTypeRestCollaborator(PaymentTypeCollaboratorService service, PaymentTypeConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final PaymentTypeCollaboratorService service;
