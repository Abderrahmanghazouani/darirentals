...
import java.util.List;
@Service
public class ReservationPlatformClientServiceImpl implements ReservationPlatformClientService {
    ...
    public ReservationPlatformClientServiceImpl(ReservationPlatformDao dao) {
        this.dao = dao;
    }
