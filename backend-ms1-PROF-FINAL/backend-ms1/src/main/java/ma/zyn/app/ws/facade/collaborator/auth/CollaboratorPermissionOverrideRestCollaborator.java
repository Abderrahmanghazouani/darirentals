package  ma.zyn.app.ws.facade.collaborator.auth;
...
@RestController
@RequestMapping("/api/collaborator/collaboratorPermissionOverride/")
public class CollaboratorPermissionOverrideRestCollaborator {
   ...
   public CollaboratorPermissionOverrideRestCollaborator(CollaboratorPermissionOverrideCollaboratorService service, CollaboratorPermissionOverrideConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final CollaboratorPermissionOverrideCollaboratorService service;
