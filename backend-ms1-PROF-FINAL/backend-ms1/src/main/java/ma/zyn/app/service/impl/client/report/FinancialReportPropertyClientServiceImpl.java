...
import java.util.List;
@Service
public class FinancialReportPropertyClientServiceImpl implements FinancialReportPropertyClientService {
    ...
    public FinancialReportPropertyClientServiceImpl(FinancialReportPropertyDao dao) {
        this.dao = dao;
    }
