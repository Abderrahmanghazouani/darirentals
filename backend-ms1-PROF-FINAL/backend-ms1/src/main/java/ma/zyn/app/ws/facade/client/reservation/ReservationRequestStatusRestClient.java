...
@RestController
@RequestMapping("/api/client/reservationRequestStatus/")
public class ReservationRequestStatusRestClient {
   ...
   public ReservationRequestStatusRestClient(ReservationRequestStatusClientService service, ReservationRequestStatusConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final ReservationRequestStatusClientService service;
