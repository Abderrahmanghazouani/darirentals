...
@RestController
@RequestMapping("/api/admin/taskStatus/")
public class TaskStatusRestAdmin {
   ...
   public TaskStatusRestAdmin(TaskStatusAdminService service, TaskStatusConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final TaskStatusAdminService service;
