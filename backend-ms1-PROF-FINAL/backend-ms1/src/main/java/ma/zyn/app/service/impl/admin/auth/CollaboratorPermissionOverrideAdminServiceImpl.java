...
import java.util.List;
@Service
public class CollaboratorPermissionOverrideAdminServiceImpl implements CollaboratorPermissionOverrideAdminService {
    ...
    public CollaboratorPermissionOverrideAdminServiceImpl(CollaboratorPermissionOverrideDao dao) {
        this.dao = dao;
    }
