...
import ma.zyn.app.ws.facade.collaborator.property.PropertyStatusRestCollaborator;
...
public class PropertyStatusRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private PropertyStatusCollaboratorServiceImpl service;
    @Mock
    private PropertyStatusConverter converter;

    @InjectMocks
    private PropertyStatusRestCollaborator controller;
