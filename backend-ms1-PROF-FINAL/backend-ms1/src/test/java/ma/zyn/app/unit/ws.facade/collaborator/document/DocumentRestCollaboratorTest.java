...
import ma.zyn.app.service.impl.collaborator.document.DocumentCollaboratorServiceImpl;
import ma.zyn.app.ws.facade.collaborator.document.DocumentRestCollaborator;
...
public class DocumentRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private DocumentCollaboratorServiceImpl service;
    @Mock
    private DocumentConverter converter;

    @InjectMocks
    private DocumentRestCollaborator controller;
