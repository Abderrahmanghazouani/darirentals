...
@SpringBootTest
class ReservationCollaboratorServiceImplTest {

    @Mock
    private ReservationDao repository;
    private AutoCloseable autoCloseable;
    private ReservationCollaboratorServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new ReservationCollaboratorServiceImpl(repository);
    }
