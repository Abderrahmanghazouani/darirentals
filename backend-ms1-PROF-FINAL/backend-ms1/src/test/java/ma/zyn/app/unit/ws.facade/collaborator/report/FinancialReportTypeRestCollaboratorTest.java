...
import ma.zyn.app.ws.facade.collaborator.report.FinancialReportTypeRestCollaborator;
...
public class FinancialReportTypeRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private FinancialReportTypeCollaboratorServiceImpl service;
    @Mock
    private FinancialReportTypeConverter converter;

    @InjectMocks
    private FinancialReportTypeRestCollaborator controller;
