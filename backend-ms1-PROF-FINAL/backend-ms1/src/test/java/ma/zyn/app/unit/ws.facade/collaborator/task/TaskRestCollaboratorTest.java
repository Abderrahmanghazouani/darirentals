...
import ma.zyn.app.service.impl.collaborator.task.TaskCollaboratorServiceImpl;
import ma.zyn.app.ws.facade.collaborator.task.TaskRestCollaborator;
...
public class TaskRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private TaskCollaboratorServiceImpl service;
    @Mock
    private TaskConverter converter;

    @InjectMocks
    private TaskRestCollaborator controller;
