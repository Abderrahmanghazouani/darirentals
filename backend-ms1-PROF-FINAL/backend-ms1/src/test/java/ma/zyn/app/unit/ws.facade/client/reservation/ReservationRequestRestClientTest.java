...
import ma.zyn.app.service.impl.client.reservation.ReservationRequestClientServiceImpl;
import ma.zyn.app.ws.facade.client.reservation.ReservationRequestRestClient;
...
public class ReservationRequestRestClientTest {

    private MockMvc mockMvc;

    @Mock
    private ReservationRequestClientServiceImpl service;
    @Mock
    private ReservationRequestConverter converter;

    @InjectMocks
    private ReservationRequestRestClient controller;
