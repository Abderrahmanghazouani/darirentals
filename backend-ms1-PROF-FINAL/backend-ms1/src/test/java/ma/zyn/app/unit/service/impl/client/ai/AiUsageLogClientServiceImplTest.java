...
import ma.zyn.app.service.impl.client.ai.AiUsageLogClientServiceImpl;
...
@SpringBootTest
class AiUsageLogClientServiceImplTest {

    @Mock
    private AiUsageLogDao repository;
    private AutoCloseable autoCloseable;
    private AiUsageLogClientServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new AiUsageLogClientServiceImpl(repository);
    }
