...
@SpringBootTest
class AiUsageLogCollaboratorServiceImplTest {

    @Mock
    private AiUsageLogDao repository;
    private AutoCloseable autoCloseable;
    private AiUsageLogCollaboratorServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new AiUsageLogCollaboratorServiceImpl(repository);
    }
