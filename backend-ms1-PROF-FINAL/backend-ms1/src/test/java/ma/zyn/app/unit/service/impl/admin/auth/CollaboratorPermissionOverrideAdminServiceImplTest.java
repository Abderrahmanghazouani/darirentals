...
@SpringBootTest
class CollaboratorPermissionOverrideAdminServiceImplTest {

    @Mock
    private CollaboratorPermissionOverrideDao repository;
    private AutoCloseable autoCloseable;
    private CollaboratorPermissionOverrideAdminServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new CollaboratorPermissionOverrideAdminServiceImpl(repository);
    }
