...
import ma.zyn.app.service.impl.admin.auth.CollaboratorPermissionOverrideAdminServiceImpl;
import ma.zyn.app.ws.facade.admin.auth.CollaboratorPermissionOverrideRestAdmin;
...
public class CollaboratorPermissionOverrideRestAdminTest {

    private MockMvc mockMvc;

    @Mock
    private CollaboratorPermissionOverrideAdminServiceImpl service;
    @Mock
    private CollaboratorPermissionOverrideConverter converter;

    @InjectMocks
    private CollaboratorPermissionOverrideRestAdmin controller;
