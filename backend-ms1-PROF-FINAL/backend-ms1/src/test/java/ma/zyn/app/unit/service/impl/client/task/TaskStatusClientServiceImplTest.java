...
import ma.zyn.app.service.impl.client.task.TaskStatusClientServiceImpl;
...
@SpringBootTest
class TaskStatusClientServiceImplTest {

    @Mock
    private TaskStatusDao repository;
    private AutoCloseable autoCloseable;
    private TaskStatusClientServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new TaskStatusClientServiceImpl(repository);
    }
