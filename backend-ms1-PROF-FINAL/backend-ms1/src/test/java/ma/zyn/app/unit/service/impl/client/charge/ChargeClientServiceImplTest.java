...
import ma.zyn.app.service.impl.client.charge.ChargeClientServiceImpl;
...
@SpringBootTest
class ChargeClientServiceImplTest {

    @Mock
    private ChargeDao repository;
    private AutoCloseable autoCloseable;
    private ChargeClientServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new ChargeClientServiceImpl(repository);
    }
