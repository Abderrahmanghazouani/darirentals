...
import ma.zyn.app.service.impl.collaborator.ai.AiQuotaCollaboratorServiceImpl;
import ma.zyn.app.ws.facade.collaborator.ai.AiQuotaRestCollaborator;
...
public class AiQuotaRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private AiQuotaCollaboratorServiceImpl service;
    @Mock
    private AiQuotaConverter converter;

    @InjectMocks
    private AiQuotaRestCollaborator controller;
