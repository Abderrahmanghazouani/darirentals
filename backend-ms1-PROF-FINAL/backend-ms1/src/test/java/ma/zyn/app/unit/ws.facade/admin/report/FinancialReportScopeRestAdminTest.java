...
import ma.zyn.app.service.impl.admin.report.FinancialReportScopeAdminServiceImpl;
import ma.zyn.app.ws.facade.admin.report.FinancialReportScopeRestAdmin;
...
public class FinancialReportScopeRestAdminTest {

    private MockMvc mockMvc;

    @Mock
    private FinancialReportScopeAdminServiceImpl service;
    @Mock
    private FinancialReportScopeConverter converter;

    @InjectMocks
    private FinancialReportScopeRestAdmin controller;
