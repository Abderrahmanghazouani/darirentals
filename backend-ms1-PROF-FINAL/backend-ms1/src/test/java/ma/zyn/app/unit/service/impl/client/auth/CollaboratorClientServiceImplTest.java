...
import ma.zyn.app.service.impl.client.auth.CollaboratorClientServiceImpl;
...
@SpringBootTest
class CollaboratorClientServiceImplTest {

    @Mock
    private CollaboratorDao repository;
    private AutoCloseable autoCloseable;
    private CollaboratorClientServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new CollaboratorClientServiceImpl(repository);
    }
