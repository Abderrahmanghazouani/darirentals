...
@SpringBootTest
class ReservationRequestStatusCollaboratorServiceImplTest {

    @Mock
    private ReservationRequestStatusDao repository;
    private AutoCloseable autoCloseable;
    private ReservationRequestStatusCollaboratorServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new ReservationRequestStatusCollaboratorServiceImpl(repository);
    }
