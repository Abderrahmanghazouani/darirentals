package ma.zyn.app.unit.ws.facade.admin.enterprise;

import ma.zyn.app.bean.core.enterprise.EnterpriseMembership;
import ma.zyn.app.service.impl.admin.enterprise.EnterpriseMembershipAdminServiceImpl;
import ma.zyn.app.ws.facade.admin.enterprise.EnterpriseMembershipRestAdmin;
...
public class EnterpriseMembershipRestAdminTest {

    private MockMvc mockMvc;

    @Mock
    private EnterpriseMembershipAdminServiceImpl service;
    @Mock
    private EnterpriseMembershipConverter converter;

    @InjectMocks
    private EnterpriseMembershipRestAdmin controller;
