...
@SpringBootTest
class ReservationRequestClientServiceImplTest {

    @Mock
    private ReservationRequestDao repository;
    private AutoCloseable autoCloseable;
    private ReservationRequestClientServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new ReservationRequestClientServiceImpl(repository);
    }
