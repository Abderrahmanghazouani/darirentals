...
import ma.zyn.app.ws.facade.admin.report.FinancialReportRestAdmin;
...
public class FinancialReportRestAdminTest {

    private MockMvc mockMvc;

    @Mock
    private FinancialReportAdminServiceImpl service;
    @Mock
    private FinancialReportConverter converter;

    @InjectMocks
    private FinancialReportRestAdmin controller;
