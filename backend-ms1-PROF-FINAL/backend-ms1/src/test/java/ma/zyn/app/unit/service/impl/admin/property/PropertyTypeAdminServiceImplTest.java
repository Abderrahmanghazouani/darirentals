...
import ma.zyn.app.service.impl.admin.property.PropertyTypeAdminServiceImpl;
...
@SpringBootTest
class PropertyTypeAdminServiceImplTest {

    @Mock
    private PropertyTypeDao repository;
    private AutoCloseable autoCloseable;
    private PropertyTypeAdminServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new PropertyTypeAdminServiceImpl(repository);
    }
