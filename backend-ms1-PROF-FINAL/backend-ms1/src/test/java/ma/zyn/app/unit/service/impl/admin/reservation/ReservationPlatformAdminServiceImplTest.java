...
@SpringBootTest
class ReservationPlatformAdminServiceImplTest {

    @Mock
    private ReservationPlatformDao repository;
    private AutoCloseable autoCloseable;
    private ReservationPlatformAdminServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new ReservationPlatformAdminServiceImpl(repository);
    }
