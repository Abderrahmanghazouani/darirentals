...
import ma.zyn.app.service.impl.client.task.TaskPriorityClientServiceImpl;
...
@SpringBootTest
class TaskPriorityClientServiceImplTest {

    @Mock
    private TaskPriorityDao repository;
    private AutoCloseable autoCloseable;
    private TaskPriorityClientServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new TaskPriorityClientServiceImpl(repository);
    }
