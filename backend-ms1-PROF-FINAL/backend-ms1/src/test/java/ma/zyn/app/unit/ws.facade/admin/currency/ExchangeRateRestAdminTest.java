...
import ma.zyn.app.ws.facade.admin.currency.ExchangeRateRestAdmin;
...
public class ExchangeRateRestAdminTest {

    private MockMvc mockMvc;

    @Mock
    private ExchangeRateAdminServiceImpl service;
    @Mock
    private ExchangeRateConverter converter;

    @InjectMocks
    private ExchangeRateRestAdmin controller;
