...
import ma.zyn.app.service.impl.admin.task.TaskTypeAdminServiceImpl;
import ma.zyn.app.ws.facade.admin.task.TaskTypeRestAdmin;
...
public class TaskTypeRestAdminTest {

    private MockMvc mockMvc;

    @Mock
    private TaskTypeAdminServiceImpl service;
    @Mock
    private TaskTypeConverter converter;

    @InjectMocks
    private TaskTypeRestAdmin controller;
