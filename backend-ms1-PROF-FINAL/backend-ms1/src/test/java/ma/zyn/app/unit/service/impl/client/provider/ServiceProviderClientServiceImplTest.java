...
import ma.zyn.app.service.impl.client.provider.ServiceProviderClientServiceImpl;
...
@SpringBootTest
class ServiceProviderClientServiceImplTest {

    @Mock
    private ServiceProviderDao repository;
    private AutoCloseable autoCloseable;
    private ServiceProviderClientServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new ServiceProviderClientServiceImpl(repository);
    }
