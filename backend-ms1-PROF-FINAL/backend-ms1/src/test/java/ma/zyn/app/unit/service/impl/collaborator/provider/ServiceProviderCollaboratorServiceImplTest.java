...
@SpringBootTest
class ServiceProviderCollaboratorServiceImplTest {

    @Mock
    private ServiceProviderDao repository;
    private AutoCloseable autoCloseable;
    private ServiceProviderCollaboratorServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new ServiceProviderCollaboratorServiceImpl(repository);
    }
