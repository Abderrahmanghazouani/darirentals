...
import ma.zyn.app.service.impl.client.property.CityClientServiceImpl;
...
@SpringBootTest
class CityClientServiceImplTest {

    @Mock
    private CityDao repository;
    private AutoCloseable autoCloseable;
    private CityClientServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new CityClientServiceImpl(repository);
    }
