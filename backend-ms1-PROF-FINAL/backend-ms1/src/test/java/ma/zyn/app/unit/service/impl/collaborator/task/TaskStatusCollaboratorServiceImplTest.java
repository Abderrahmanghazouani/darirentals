...
@SpringBootTest
class TaskStatusCollaboratorServiceImplTest {

    @Mock
    private TaskStatusDao repository;
    private AutoCloseable autoCloseable;
    private TaskStatusCollaboratorServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new TaskStatusCollaboratorServiceImpl(repository);
    }
