...
import ma.zyn.app.service.impl.admin.enterprise.EnterpriseAdminServiceImpl;
import ma.zyn.app.ws.facade.admin.enterprise.EnterpriseRestAdmin;
...
public class EnterpriseRestAdminTest {

    private MockMvc mockMvc;

    @Mock
    private EnterpriseAdminServiceImpl service;
    @Mock
    private EnterpriseConverter converter;

    @InjectMocks
    private EnterpriseRestAdmin controller;
