...
import ma.zyn.app.service.impl.client.payment.PaymentClientServiceImpl;
...
class PaymentClientServiceImplTest {
    ...
    private PaymentClientServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new PaymentClientServiceImpl(repository);
    }
