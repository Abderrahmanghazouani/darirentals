...
import ma.zyn.app.ws.facade.collaborator.report.FinancialReportPropertyRestCollaborator;
...
public class FinancialReportPropertyRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private FinancialReportPropertyCollaboratorServiceImpl service;
    @Mock
    private FinancialReportPropertyConverter converter;

    @InjectMocks
    private FinancialReportPropertyRestCollaborator controller;
