...
import ma.zyn.app.ws.facade.admin.reservation.ReservationRequestRestAdmin;
...
public class ReservationRequestRestAdminTest {

    private MockMvc mockMvc;

    @Mock
    private ReservationRequestAdminServiceImpl service;
    @Mock
    private ReservationRequestConverter converter;

    @InjectMocks
    private ReservationRequestRestAdmin controller;
