...
@SpringBootTest
class FinancialReportScopeAdminServiceImplTest {

    @Mock
    private FinancialReportScopeDao repository;
    private AutoCloseable autoCloseable;
    private FinancialReportScopeAdminServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new FinancialReportScopeAdminServiceImpl(repository);
    }
