...
import ma.zyn.app.ws.facade.collaborator.charge.ChargeRestCollaborator;
...
public class ChargeRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private ChargeCollaboratorServiceImpl service;
    @Mock
    private ChargeConverter converter;

    @InjectMocks
    private ChargeRestCollaborator controller;
