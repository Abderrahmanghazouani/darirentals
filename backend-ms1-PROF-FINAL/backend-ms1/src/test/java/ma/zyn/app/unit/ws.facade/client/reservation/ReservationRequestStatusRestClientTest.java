package ma.zyn.app.unit.ws.facade.client.reservation;

import ma.zyn.app.bean.core.reservation.ReservationRequestStatus;
import ma.zyn.app.service.impl.client.reservation.ReservationRequestStatusClientServiceImpl;
import ma.zyn.app.ws.facade.client.reservation.ReservationRequestStatusRestClient;
...
public class ReservationRequestStatusRestClientTest {

    private MockMvc mockMvc;

    @Mock
    private ReservationRequestStatusClientServiceImpl service;
    @Mock
    private ReservationRequestStatusConverter converter;

    @InjectMocks
    private ReservationRequestStatusRestClient controller;
