...
import ma.zyn.app.service.impl.client.reservation.ReservationPlatformClientServiceImpl;
...
@SpringBootTest
class ReservationPlatformClientServiceImplTest {

    @Mock
    private ReservationPlatformDao repository;
    private AutoCloseable autoCloseable;
    private ReservationPlatformClientServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new ReservationPlatformClientServiceImpl(repository);
    }
