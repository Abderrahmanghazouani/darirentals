...
import ma.zyn.app.ws.facade.admin.task.TaskStatusRestAdmin;
...
public class TaskStatusRestAdminTest {

    private MockMvc mockMvc;

    @Mock
    private TaskStatusAdminServiceImpl service;
    @Mock
    private TaskStatusConverter converter;

    @InjectMocks
    private TaskStatusRestAdmin controller;
