...
import ma.zyn.app.service.impl.collaborator.ai.AiUsageLogCollaboratorServiceImpl;
import ma.zyn.app.ws.facade.collaborator.ai.AiUsageLogRestCollaborator;
...
public class AiUsageLogRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private AiUsageLogCollaboratorServiceImpl service;
    @Mock
    private AiUsageLogConverter converter;

    @InjectMocks
    private AiUsageLogRestCollaborator controller;
