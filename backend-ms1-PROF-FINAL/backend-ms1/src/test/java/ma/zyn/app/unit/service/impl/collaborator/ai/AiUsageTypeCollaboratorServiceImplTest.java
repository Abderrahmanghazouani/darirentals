package ma.zyn.app.unit.service.impl.collaborator.ai;
...
@SpringBootTest
class AiUsageTypeCollaboratorServiceImplTest {

    @Mock
    private AiUsageTypeDao repository;
    private AutoCloseable autoCloseable;
    private AiUsageTypeCollaboratorServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new AiUsageTypeCollaboratorServiceImpl(repository);
    }
