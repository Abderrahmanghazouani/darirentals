package ma.zyn.app.unit.service.impl.collaborator.payment;
...
@SpringBootTest
class PaymentStatusCollaboratorServiceImplTest {

    @Mock
    private PaymentStatusDao repository;
    private AutoCloseable autoCloseable;
    private PaymentStatusCollaboratorServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new PaymentStatusCollaboratorServiceImpl(repository);
    }
