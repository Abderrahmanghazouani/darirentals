...
import ma.zyn.app.ws.facade.admin.property.PropertyTypeRestAdmin;
...
public class PropertyTypeRestAdminTest {

    private MockMvc mockMvc;

    @Mock
    private PropertyTypeAdminServiceImpl service;
    @Mock
    private PropertyTypeConverter converter;

    @InjectMocks
    private PropertyTypeRestAdmin controller;
