...
import ma.zyn.app.ws.facade.admin.provider.ServiceTypeRestAdmin;
...
public class ServiceTypeRestAdminTest {

    private MockMvc mockMvc;

    @Mock
    private ServiceTypeAdminServiceImpl service;
    @Mock
    private ServiceTypeConverter converter;

    @InjectMocks
    private ServiceTypeRestAdmin controller;
