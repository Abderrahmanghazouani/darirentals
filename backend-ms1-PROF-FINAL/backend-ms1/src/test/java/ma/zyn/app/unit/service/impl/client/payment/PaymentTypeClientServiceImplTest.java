...
import ma.zyn.app.service.impl.client.payment.PaymentTypeClientServiceImpl;
...
@SpringBootTest
class PaymentTypeClientServiceImplTest {

    @Mock
    private PaymentTypeDao repository;
    private AutoCloseable autoCloseable;
    private PaymentTypeClientServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new PaymentTypeClientServiceImpl(repository);
    }
