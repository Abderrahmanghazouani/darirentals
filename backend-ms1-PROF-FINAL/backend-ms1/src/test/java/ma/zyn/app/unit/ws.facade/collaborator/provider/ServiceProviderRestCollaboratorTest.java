...
import ma.zyn.app.service.impl.collaborator.provider.ServiceProviderCollaboratorServiceImpl;
import ma.zyn.app.ws.facade.collaborator.provider.ServiceProviderRestCollaborator;
...
public class ServiceProviderRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private ServiceProviderCollaboratorServiceImpl service;
    @Mock
    private ServiceProviderConverter converter;

    @InjectMocks
    private ServiceProviderRestCollaborator controller;
