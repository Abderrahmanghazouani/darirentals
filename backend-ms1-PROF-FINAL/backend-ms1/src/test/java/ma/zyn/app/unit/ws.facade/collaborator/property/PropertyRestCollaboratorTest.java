...
import ma.zyn.app.ws.facade.collaborator.property.PropertyRestCollaborator;
...
public class PropertyRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private PropertyCollaboratorServiceImpl service;
    @Mock
    private PropertyConverter converter;

    @InjectMocks
    private PropertyRestCollaborator controller;
