...
import ma.zyn.app.service.impl.collaborator.reservation.ReservationCollaboratorServiceImpl;
import ma.zyn.app.ws.facade.collaborator.reservation.ReservationRestCollaborator;
...
public class ReservationRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private ReservationCollaboratorServiceImpl service;
    @Mock
    private ReservationConverter converter;

    @InjectMocks
    private ReservationRestCollaborator controller;
