package ma.zyn.app.unit.service.impl.client.reservation;
...
@SpringBootTest
class ReservationRequestStatusClientServiceImplTest {

    @Mock
    private ReservationRequestStatusDao repository;
    private AutoCloseable autoCloseable;
    private ReservationRequestStatusClientServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new ReservationRequestStatusClientServiceImpl(repository);
    }
