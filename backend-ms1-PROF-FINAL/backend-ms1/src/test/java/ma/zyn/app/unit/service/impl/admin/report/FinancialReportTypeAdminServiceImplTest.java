...
@SpringBootTest
class FinancialReportTypeAdminServiceImplTest {

    @Mock
    private FinancialReportTypeDao repository;
    private AutoCloseable autoCloseable;
    private FinancialReportTypeAdminServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new FinancialReportTypeAdminServiceImpl(repository);
    }
