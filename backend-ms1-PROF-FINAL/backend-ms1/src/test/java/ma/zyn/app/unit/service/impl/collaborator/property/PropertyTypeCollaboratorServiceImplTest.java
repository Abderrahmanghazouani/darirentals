...
@SpringBootTest
class PropertyTypeCollaboratorServiceImplTest {

    @Mock
    private PropertyTypeDao repository;
    private AutoCloseable autoCloseable;
    private PropertyTypeCollaboratorServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new PropertyTypeCollaboratorServiceImpl(repository);
    }
