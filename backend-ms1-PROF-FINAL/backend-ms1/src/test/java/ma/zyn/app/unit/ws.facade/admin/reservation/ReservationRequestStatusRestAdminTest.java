...
import ma.zyn.app.ws.facade.admin.reservation.ReservationRequestStatusRestAdmin;
...
public class ReservationRequestStatusRestAdminTest {

    private MockMvc mockMvc;

    @Mock
    private ReservationRequestStatusAdminServiceImpl service;
    @Mock
    private ReservationRequestStatusConverter converter;

    @InjectMocks
    private ReservationRequestStatusRestAdmin controller;
