...
@SpringBootTest
class ReservationRequestCollaboratorServiceImplTest {

    @Mock
    private ReservationRequestDao repository;
    private AutoCloseable autoCloseable;
    private ReservationRequestCollaboratorServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new ReservationRequestCollaboratorServiceImpl(repository);
    }
