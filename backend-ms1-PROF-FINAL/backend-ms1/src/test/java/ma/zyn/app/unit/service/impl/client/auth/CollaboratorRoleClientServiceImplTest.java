...
import ma.zyn.app.service.impl.client.auth.CollaboratorRoleClientServiceImpl;
...
@SpringBootTest
class CollaboratorRoleClientServiceImplTest {

    @Mock
    private CollaboratorRoleDao repository;
    private AutoCloseable autoCloseable;
    private CollaboratorRoleClientServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new CollaboratorRoleClientServiceImpl(repository);
    }
