package ma.zyn.app.unit.ws.facade.collaborator.client;
...
import ma.zyn.app.ws.facade.collaborator.client.ClientRestCollaborator;
...
public class ClientRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private ClientCollaboratorServiceImpl service;
    @Mock
    private ClientConverter converter;

    @InjectMocks
    private ClientRestCollaborator controller;
    ...
    public void itShouldSaveClientTest() throws Exception {
        ...
        assertEquals(savedDto.getNationality(), responseBody.getNationality());
