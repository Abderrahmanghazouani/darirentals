...
public class ChargeTypeRestAdminTest {

    private MockMvc mockMvc;

    @Mock
    private ChargeTypeAdminServiceImpl service;
    @Mock
    private ChargeTypeConverter converter;

    @InjectMocks
    private ChargeTypeRestAdmin controller;
