...
import ma.zyn.app.service.impl.collaborator.auth.CollaboratorRoleCollaboratorServiceImpl;
import ma.zyn.app.ws.facade.collaborator.auth.CollaboratorRoleRestCollaborator;
...
public class CollaboratorRoleRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private CollaboratorRoleCollaboratorServiceImpl service;
    @Mock
    private CollaboratorRoleConverter converter;

    @InjectMocks
    private CollaboratorRoleRestCollaborator controller;
