...
import ma.zyn.app.service.impl.collaborator.payment.PaymentStatusCollaboratorServiceImpl;
import ma.zyn.app.ws.facade.collaborator.payment.PaymentStatusRestCollaborator;
...
public class PaymentStatusRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private PaymentStatusCollaboratorServiceImpl service;
    @Mock
    private PaymentStatusConverter converter;

    @InjectMocks
    private PaymentStatusRestCollaborator controller;
