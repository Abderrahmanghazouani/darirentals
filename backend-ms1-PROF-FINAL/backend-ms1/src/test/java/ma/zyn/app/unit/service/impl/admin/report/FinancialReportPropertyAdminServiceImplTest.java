...
@SpringBootTest
class FinancialReportPropertyAdminServiceImplTest {

    @Mock
    private FinancialReportPropertyDao repository;
    private AutoCloseable autoCloseable;
    private FinancialReportPropertyAdminServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new FinancialReportPropertyAdminServiceImpl(repository);
    }
