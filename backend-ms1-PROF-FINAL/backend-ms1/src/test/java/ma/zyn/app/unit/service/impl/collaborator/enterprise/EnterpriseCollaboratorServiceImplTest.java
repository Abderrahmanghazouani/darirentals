...
@SpringBootTest
class EnterpriseCollaboratorServiceImplTest {

    @Mock
    private EnterpriseDao repository;
    private AutoCloseable autoCloseable;
    private EnterpriseCollaboratorServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new EnterpriseCollaboratorServiceImpl(repository);
    }
