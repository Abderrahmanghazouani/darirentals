...
import ma.zyn.app.ws.facade.admin.document.DocumentTypeRestAdmin;
...
public class DocumentTypeRestAdminTest {

    private MockMvc mockMvc;

    @Mock
    private DocumentTypeAdminServiceImpl service;
    @Mock
    private DocumentTypeConverter converter;

    @InjectMocks
    private DocumentTypeRestAdmin controller;
