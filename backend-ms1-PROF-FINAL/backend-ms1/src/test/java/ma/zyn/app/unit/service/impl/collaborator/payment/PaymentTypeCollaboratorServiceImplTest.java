...
@SpringBootTest
class PaymentTypeCollaboratorServiceImplTest {

    @Mock
    private PaymentTypeDao repository;
    private AutoCloseable autoCloseable;
    private PaymentTypeCollaboratorServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new PaymentTypeCollaboratorServiceImpl(repository);
    }
