...
public class DocumentRestClientTest {

    private MockMvc mockMvc;

    @Mock
    private DocumentClientServiceImpl service;
    @Mock
    private DocumentConverter converter;

    @InjectMocks
    private DocumentRestClient controller;
