...
@SpringBootTest
class ReservationStatusAdminServiceImplTest {

    @Mock
    private ReservationStatusDao repository;
    private AutoCloseable autoCloseable;
    private ReservationStatusAdminServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new ReservationStatusAdminServiceImpl(repository);
    }
