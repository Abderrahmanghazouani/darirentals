...
@SpringBootTest
class FinancialReportCollaboratorServiceImplTest {

    @Mock
    private FinancialReportDao repository;
    private AutoCloseable autoCloseable;
    private FinancialReportCollaboratorServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new FinancialReportCollaboratorServiceImpl(repository);
    }
