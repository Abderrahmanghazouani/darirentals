...
@SpringBootTest
class CollaboratorRoleCollaboratorServiceImplTest {

    @Mock
    private CollaboratorRoleDao repository;
    private AutoCloseable autoCloseable;
    private CollaboratorRoleCollaboratorServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new CollaboratorRoleCollaboratorServiceImpl(repository);
    }
