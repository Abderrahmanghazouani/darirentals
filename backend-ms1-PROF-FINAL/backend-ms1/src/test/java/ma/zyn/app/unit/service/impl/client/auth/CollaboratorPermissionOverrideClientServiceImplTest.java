package ma.zyn.app.unit.service.impl.client.auth;
...
import ma.zyn.app.service.impl.client.auth.CollaboratorPermissionOverrideClientServiceImpl;
...
@SpringBootTest
class CollaboratorPermissionOverrideClientServiceImplTest {

    @Mock
    private CollaboratorPermissionOverrideDao repository;
    private AutoCloseable autoCloseable;
    private CollaboratorPermissionOverrideClientServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new CollaboratorPermissionOverrideClientServiceImpl(repository);
    }
