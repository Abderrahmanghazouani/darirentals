...
export default function TasksPage() {
  ...
  }, [scopedItems, filterProperty, filterStatus, filterPriority, filterAssignee, onlyOverdue]);

  const overdueCount = useMemo(() => scopedItems.filter(isOverdue).length, [scopedItems]);
